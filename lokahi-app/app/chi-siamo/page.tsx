    ...
    <main className="min-h-screen bg-[#fffaf5] text-[#1e1b18]">
          ...
          <div className="p-9 md:p-16">
            ...
            <div className="mt-8 space-y-6 leading-8 text-[#6d6964]">
              <p>
                ...
                ventun anni per riuscire ad accettarsi pienamente.
              </p>
              ...
              <p>
                A ventun anni ha fatto coming out. Da quel momento è iniziato
      ...
      <section className="bg-[#1e1b18] px-6 py-24 text-white md:px-12 lg:px-20 lg:py-32">
        <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-2">
          ...
          <div className="space-y-6 text-lg leading-9 text-white/65">
            ...
            <p>
              Attraverso viaggi ed esperienze di gruppo dedicati a donne
              lesbiche, bisessuali e queer, LOKAHI crea occasioni per
              incontrarsi, confrontarsi e vivere liberamente la propria
              identità.
            </p>
      ...
      <section className="m-3 rounded-[34px] bg-[#ef8b43] px-7 py-20 md:m-6 md:px-14 lg:px-20 lg:py-24">
        <p className="text-xs font-bold uppercase tracking-[0.2em]">
          Il significato di LOKAHI
        </p>

        <h2 className="mt-5 max-w-5xl text-5xl font-bold leading-[0.98] tracking-[-0.055em] md:text-7xl">
          Corpo, mente e dimensione spirituale in armonia.
        </h2>

        <p className="mt-7 max-w-3xl text-lg leading-8">
          Per noi, LOKAHI rappresenta equilibrio, energia positiva e
          connessione. Persone diverse che si incontrano, si sostengono e
          ritrovano insieme il proprio equilibrio.
        </p>
