...
export default function Islanda2027Page() {
    return (
        <main className="min-h-screen bg-[#fffaf5] text-[#402216]">
            ...
            <section className="relative flex min-h-screen w-full items-center overflow-hidden">
                <div
                    ...
                    style={{
                        backgroundImage: "url('/islanda-2027.jpg')",
                    }}
                />

                <div className="absolute inset-0 bg-gradient-to-t from-[#111b20] via-[#172a32]/60 to-[#17352d]/20" />
                ...
                <div className="relative z-10 mx-auto w-full max-w-6xl px-6 py-32 text-center text-white md:px-12">
                    ...
                    <h1 className="mt-5 text-5xl font-bold leading-none tracking-[-0.06em] sm:text-7xl md:text-9xl">
                        Islanda
                        <br />
                        2027
                    </h1>
                    ...
                    <p className="mx-auto mt-7 max-w-2xl text-lg leading-8 text-white/85 md:text-xl">
                        Natura selvaggia, ghiaccio, cascate e cieli illuminati
                        dall’aurora boreale.
                    </p>
                    ...
                    <div className="mt-12 grid gap-4 md:grid-cols-3">
                        <div className="rounded-[28px] bg-[#f5e7d8] p-7">
                            ...
                            <p className="mt-3 leading-7 text-[#6d564b]">
                                Notti alla ricerca delle luci del Nord.
                            </p>
                        </div>
                        ...
                        <div className="rounded-[28px] bg-[#ef8b43] p-7">
                            ...
                            <p className="mt-3 leading-7 text-[#5e3524]">
                                Ghiacciai e paesaggi che sembrano irreali.
                            </p>
                        </div>
                        ...
                        <div className="rounded-[28px] bg-[#402216] p-7 text-white">
                            ...
                            <p className="mt-3 leading-7 text-white/70">
                                Cascate, oceano e una terra ancora selvaggia.
                            </p>
                        </div>
                    </div>
